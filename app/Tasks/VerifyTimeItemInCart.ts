...
export default class VerifyTimeItemInCart extends BaseTask {
  /**
      * qualquer valor
      , separador de lita de valores
      - faixa de valores
      / valores de passo

      como funciona 'crom tab'
   */
  ...
  /**
   * Defina ativar o uso do arquivo .lock para tarefa de repetição de execução de bloco
  ...
  public async handle() {
    ...
    try {
      ...
      Logger.error('Error in return Cart Items')
    }
  }
}
